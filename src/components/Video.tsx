                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img
                                ...
                                src="https://github.com/Nanitamo.png"
                                alt="" />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block"> Nanitamo Antonio</strong>
                                <span className="text-gra-200 text-sm block">CEO @Bug Solutions</span>
                            </div>
                        </div>
                    </div>
